...
---
Two-field discipline (Suno idiom): **Style field** = 4–7 comma descriptors using the
...
**What's ignored/filtered**: artist names (describe the sound instead), exact BPM
(approximate), negative text in Style ("no drums" — use the Exclude field),
