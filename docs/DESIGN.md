...
| Hue | Hex | Job |
|---|---|---|
| **Amber (you)** | `#FFB454` | asks, answers, actions (all primary buttons) |
...
- **The ask is the headline.** Your words render as the largest type on the
  screen, in amber — the tool's voice never upstages yours (rule R4).
- **Interrogation as typeset conversation**: dim question, indented amber answer,
